...
from models.alexnet import camelyon_feat_projecter, teacher_Attention_head, student_head
...
def get_parser():
    ...
    parser.add_argument('--smoothE', default=10, type=int, help='num of epoch to apply StuFilter')
...
if __name__ == "__main__":
    ...
    model_teacherHead = teacher_Attention_head(input_feat_dim=512).to(dev)
    ...
    val_ds_return_instance = TCGA_LungCancer_Feat(train=False, return_bag=False)
    val_ds_return_bag = TCGA_LungCancer_Feat(train=False, return_bag=True)
